...
public class SavedJobsAdapter extends RecyclerView.Adapter<SavedJobsAdapter.JobInfoViewHolder>{
    ...
    public SavedJobsAdapter(List<JobPostingforUser> itemList, ItemClickListener clickListener ){
    ...
    public class JobInfoViewHolder extends RecyclerView.ViewHolder{
        ...
        public void getLikeStatus(JobInfoViewHolder holder, String postId, String uid){
